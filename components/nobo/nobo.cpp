...
#if defined(MAX_TEMP_YAML)
static_assert(MAX_TEMP_YAML >= 10, "MAX_TEMP_YAML too low (must be >= 10)");
static_assert(MAX_TEMP_YAML <= 30, "MAX_TEMP_YAML too high (must be <= 30)");
constexpr uint8_t MAX_TEMP = MAX_TEMP_YAML;
#else
